async function ser() {
    ...
    try {
        ...
        document.getElementById("card_tem1").innerHTML = `${forecast.list[0].main.temp}<sup style="font-size: 10px;">0</sup>C`;
        ...
        document.getElementById("card_tem2").innerHTML = `${forecast.list[1].main.temp}<sup style="font-size: 10px;">0</sup>C`;
        ...
        document.getElementById("card_tem3").innerHTML = `${forecast.list[2].main.temp}<sup style="font-size: 10px;">0</sup>C`;
        ...
        document.getElementById("card_tem4").innerHTML = `${forecast.list[3].main.temp}<sup style="font-size: 10px;">0</sup>C`;
        ...
        document.getElementById("card_tem5").innerHTML = `${forecast.list[4].main.temp}<sup style="font-size: 10px;">0</sup>C`;
        ...
        document.getElementById("card_tem6").innerHTML = `${forecast.list[5].main.temp}<sup style="font-size: 10px;">0</sup>C`;
        ...
        document.getElementById("card_tem7").innerHTML = `${forecast.list[6].main.temp}<sup style="font-size: 10px;">0</sup>C`;
        ...
        document.getElementById("card_tem8").innerHTML = `${forecast.list[7].main.temp}<sup style="font-size: 10px;">0</sup>C`;
